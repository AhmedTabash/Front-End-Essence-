    ...
    return (
        <div className="nav-par-side">
            ...
            <ul className="nav-sec nav-home-sec">
                <li>
                    <NavLink aria-label="Nav Link" to={`/user/appointment/${userId}`} onClick={toggleNavPar} >
                ...
                <li>
                    <NavLink aria-label="Nav Link" to={`/user/appointment-end/${userId}`}  onClick={toggleNavPar}>
                        <div className='list-icon' >
                ...
                <li>
                    <NavLink aria-label="Nav Link" to="/book-now" onClick={toggleNavPar} >
                        <div className='list-icon' >
